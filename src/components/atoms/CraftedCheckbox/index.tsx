...
const CraftedCheckbox = ({
  ...
  return (
    <label>
      ...
      <span
        className={twMerge(
          'group block w-12 p-0.5 rounded-full text-2xs font-semibold border text-center cursor-pointer',
      ...
      >
        <span className='hidden peer-checked:group-[]:block'>Crafted</span>
        <span className='block peer-checked:group-[]:hidden'>Owned</span>
      </span>
    </label>
  )
}
